...
async fn main() {
    ...
    let app = Router::new()
        ...
        .with_state(app_state); // The with_state method allows us to add state to the state managed by this instance of Axum. Then we can use this state in the handlers.
